    ...
    >
      ...
      <div className="g-container" style={{ paddingTop: "var(--space-6)", paddingBottom: "var(--space-12)" }}>
        <div
          ...
          style={{ gridTemplateColumns: "1fr 2fr 280px" }}
          data-testid="trustware-terminal-grid"
        >
          {/* Left spacer for visual balance */}
          <div onClick={handleBackgroundClick} className="cursor-default" />

          {/* Main Audit Stack */}
          <main className="space-y-4" onClick={(e) => e.stopPropagation()} data-testid="trustware-audit-stack">
            {slots.length === 0 ? (
              <div
                className="rounded-2xl border p-8 text-center"
                style={{ borderColor: "var(--color-border)", backgroundColor: "var(--color-surface)" }}
                data-testid="trustware-empty-state"
              >
